<template>
    <div style="width: 100%;height: 100vh;background-color: darkcyan;overflow: hidden">
        <div style="width: 400px; margin: 100px auto">
            <div style="font-size: 30px; text-align: center; padding: 30px 0">welcome to register</div>
            <el-form ref="form" :model="form" size="normal" :rules="rules">
                ...
                <el-form-item>
                  <el-button style="width: 100%" type="primary" @click="returnToLogin">return to login</el-button>
                </el-form-item>
            </el-form>
        </div>
        <router-view />
                    ...
                    if (valid) {
                        request.post("/user/register",this.form).then(res=>{
                            if (res.data.code === '0') {
                                ...
                                this.$router.push("/login")  //注册成功后进行页面的跳转，跳转到登录页
                            } else {
                                this.$message({
                                    type: "error",
